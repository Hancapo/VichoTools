...
class BitmapInfoHeader:
    ...
    YPixelsPerMeter: int
    ColorUsedCount: int
    ColorImportantCount: int
    def Equals(self, obj: Any) -> bool: ...
    def GetHashCode(self) -> int: ...
    def GetType(self) -> Any: ...
    def ToString(self) -> str: ...

class ComBaseStreamNative:
    Callback: Any
...
class ComStream:
    ...
    def Commit(self, grfCommitFlags: CommitFlags) -> None: ...
    def CopyTo(self, stmRef: IStream, cb: int, cbWrittenRef: int) -> int: ...
    def Dispose(self) -> None: ...
    def Equals(self, obj: Any) -> bool: ...
    def GetHashCode(self) -> int: ...
    def GetStatistics(self, grfStatFlag: StorageStatisticsFlags) -> StorageStatistics: ...
    def GetType(self) -> Any: ...
    def LockRegion(self, libOffset: int, cb: int, dwLockType: LockType) -> None: ...
    @overload
    ...
    def Read(self, vRef: Any, cb: int) -> int: ...
    def Revert(self) -> None: ...
    def Seek(self, dlibMove: int, dwOrigin: Any) -> int: ...
...
class ErrorCode(IntEnum):
    ...
    NdisDot11ApChannelCurrentlyNotAvailable = -2144067579
    NdisDot11ApBandCurrentlyNotAvailable = -2144067578
    NdisDot11ApChannelNotAllowed = -2144067577
    NdisDot11ApBandNotAllowed = -2144067576
    ...
    VolsnapActivationTimeout = -2138963966
    TieringNotSupportedOnVolume = -2138898431
    TieringVolumeDismountInProgress = -2138898430
    TieringStorageTierNotFound = -2138898429
    TieringInvalidFileId = -2138898428
    TieringWrongClusterNode = -2138898427
    TieringAlreadyProcessing = -2138898426
    TieringCannotPinObject = -2138898425
    TieringFileIsNotPinned = -2138898424
    NotATieredVolume = -2138898423
    AttributeNotPresent = -2138898422
    DbgCreateProcessFailureLockdown = -2135949311
    DbgAttachProcessFailureLockdown = -2135949310
    DbgConnectServerFailureLockdown = -2135949309
    DbgStartServerFailureLockdown = -2135949308
    SpacesFaultDomainTypeInvalid = -2132344831
    SpacesInternalError = -2132344830
    SpacesResiliencyTypeInvalid = -2132344829
    SpacesDriveSectorSizeInvalid = -2132344828
    SpacesDriveRedundancyInvalid = -2132344826
    SpacesNumberOfDataCopiesInvalid = -2132344825
    SpacesParityLayoutInvalid = -2132344824
    SpacesInterleaveLengthInvalid = -2132344823
    SpacesNumberOfColumnsInvalid = -2132344822
    SpacesNotEnoughDrives = -2132344821
    SpacesExtendedError = -2132344820
    SpacesProvisioningTypeInvalid = -2132344819
    SpacesAllocationSizeInvalid = -2132344818
    SpacesEnclosureAwareInvalid = -2132344817
    SpacesWriteCacheSizeInvalid = -2132344816
    SpacesNumberOfGroupsInvalid = -2132344815
    SpacesDriveOperationalStateInvalid = -2132344814
    ...
    GraphicsWindowdcNotAvailable = -1071243251
    GraphicsWindowlessPresentDisabled = -1071243250
    ...
    HvCpuidXsaveFeatureValidation = -1070268355
    HvProcessorStartupTimeout = -1070268354
    HvSmxEnabled = -1070268353
    HvInvalidLpIndex = -1070268351
    HvInvalidRegisterValue = -1070268336
    HvInvalidVtlState = -1070268335
    HvNxNotDetected = -1070268331
    HvInvalidDeviceId = -1070268329
    HvInvalidDeviceState = -1070268328
    HvPageRequestInvalid = -1070268320
    HvInvalidCpuGroupId = -1070268305
    HvInvalidCpuGroupState = -1070268304
    HvOperationFailed = -1070268303
    HvNotAllowedWithNestedVirtActive = -1070268302
    ...
    VidVtlAccessDenied = -1070137302
    VmcomputeTerminatedDuringStart = -1070137088
    VmcomputeImageMismatch = -1070137087
    VmcomputeHypervNotInstalled = -1070137086
    VmcomputeOperationPending = -1070137085
    VmcomputeTooManyNotifications = -1070137084
    VmcomputeInvalidState = -1070137083
    VmcomputeUnexpectedExit = -1070137082
    VmcomputeTerminated = -1070137081
    VmcomputeConnectFailed = -1070137080
    VmcomputeTimeout = -1070137079
    VmcomputeConnectionClosed = -1070137078
    VmcomputeUnknownMessage = -1070137077
    VmcomputeUnsupportedProtocolVersion = -1070137076
    VmcomputeInvalidJson = -1070137075
    VmcomputeSystemNotFound = -1070137074
    VmcomputeSystemAlreadyExists = -1070137073
    VmcomputeSystemAlreadyStopped = -1070137072
    VmcomputeProtocolError = -1070137071
    VmcomputeInvalidLayer = -1070137070
    VmcomputeWindowsInsiderRequired = -1070137069
    ...
    VirtdiskDiskAlreadyOwned = -1069940706
    VirtdiskDiskOnlineAndWritable = -1069940705
    CtlogTrackingNotInitialized = -1069940704
    CtlogLogfileSizeExceededMaxsize = -1069940703
    CtlogVhdChangedOffline = -1069940702
    CtlogInvalidTrackingState = -1069940701
    CtlogInconsistentTrackingFile = -1069940700
    VhdResizeWouldTruncateData = -1069940699
    VhdCouldNotComputeMinimumVirtualSize = -1069940698
    VhdAlreadyAtOrBelowMinimumVirtualSize = -1069940697
    VhdMetadataFull = -1069940696
    VhdInvalidChangeTrackingId = -1069940695
    VhdChangeTrackingDisabled = -1069940694
    VhdMissingChangeTrackingInformation = -1069940688
    SvhdxErrorStored = -1067712512
    SvhdxErrorNotAvailable = -1067647232
    SvhdxUnitAttentionAvailable = -1067647231
    SvhdxUnitAttentionCapacityDataChanged = -1067647230
    SvhdxUnitAttentionReservationsPreempted = -1067647229
    SvhdxUnitAttentionReservationsReleased = -1067647228
    SvhdxUnitAttentionRegistrationsPreempted = -1067647227
    SvhdxUnitAttentionOperatingDefinitionChanged = -1067647226
    SvhdxReservationConflict = -1067647225
    SvhdxWrongFileType = -1067647224
    SvhdxVersionMismatch = -1067647223
    VhdShared = -1067647222
    SvhdxNoInitiator = -1067647221
    VhdsetBackingStorageNotFound = -1067647220
    SmbNoPreauthIntegrityHashOverlap = -1067646976
    SmbBadClusterDialect = -1067646975
    SeccoreInvalidCommand = -1058537472
    NoApplicableAppLicensesFound = -1058406399
    ClipLicenseNotFound = -1058406398
    ClipDeviceLicenseMissing = -1058406397
    ClipLicenseInvalidSignature = -1058406396
    ClipKeyholderLicenseMissingOrInvalid = -1058406395
    ClipLicenseExpired = -1058406394
    ClipLicenseSignedByUnknownSource = -1058406393
    ClipLicenseNotSigned = -1058406392
    ClipLicenseHardwareIdOutOfTolerance = -1058406391
    ClipLicenseDeviceIdMismatch = -1058406390
...
class ErrorCodeHelper:
    ...
    @overload
    @staticmethod
    def ToResult(errorCode: ErrorCode) -> SharpDX.Result: ...
    @overload
    @staticmethod
    def ToResult(errorCode: int) -> SharpDX.Result: ...
    def ToString(self) -> str: ...

class IStream:
    def Clone(self) -> IStream: ...
    def Commit(self, commitFlags: CommitFlags) -> None: ...
    def CopyTo(self, streamDest: IStream, numberOfBytesToCopy: int, bytesWritten: int) -> int: ...
    def GetStatistics(self, storageStatisticsFlags: StorageStatisticsFlags) -> StorageStatistics: ...
    def LockRegion(self, offset: int, numberOfBytesToLock: int, dwLockType: LockType) -> None: ...
    def Revert(self) -> None: ...
    def Seek(self, offset: int, origin: Any) -> int: ...
    def SetSize(self, newSize: int) -> None: ...
    def UnlockRegion(self, offset: int, numberOfBytesToLock: int, dwLockType: LockType) -> None: ...

class IStreamBase:
    def Read(self, buffer: Any, numberOfBytesToRead: int) -> int: ...
    def Write(self, buffer: Any, numberOfBytesToRead: int) -> int: ...
...
class NativeMessage:
    ...
    lParam: Any
    time: int
    p: SharpDX.Mathematics.Interop.RawPoint
    def Equals(self, obj: Any) -> bool: ...
    def GetHashCode(self) -> int: ...
    def GetType(self) -> Any: ...
    def ToString(self) -> str: ...
...
class PropertyBag:
    ...
    NativePointer: Any
    IsDisposed: bool
    def __init__(self, propertyBagPointer: Any) -> None: ...
    def Dispose(self) -> None: ...
    def Equals(self, obj: Any) -> bool: ...
    @overload
    def Get(self, name: str) -> Any: ...
    @overload
    def Get(self, propertyKey: PropertyBagKey[T1, T2]) -> T1: ...
    def GetHashCode(self) -> int: ...
    def GetType(self) -> Any: ...
    @overload
    def QueryInterface(self, guid: Any, outPtr: Any) -> None: ...
    ...
    @overload
    def Set(self, propertyKey: PropertyBagKey[T1, T2], value: T1) -> None: ...
    def ToString(self) -> str: ...

class PropertyBagKey(Generic[T1, T2]):
    Name: str
...
class StorageStatisticsFlags(IntFlag):
    Default = 0
    None_ = 0
    NoName = 1

class Variant:
    ElementType: VariantElementType
    Type: VariantType
    Value: Any
    def Equals(self, obj: Any) -> bool: ...
    def GetHashCode(self) -> int: ...
...
class VariantElementType(IntEnum):
    Empty = 0
    Null = 1
    Short = 2
    Int = 3
